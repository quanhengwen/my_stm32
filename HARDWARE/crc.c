...
*********************************************************************/
unsigned short GetCRC(unsigned char CRCArray[],unsigned char ArrayLen)
{
	unsigned char chCRCH = 0xFF; // 高CRC字节初始化
	unsigned char chCRCL = 0xFF; // 低CRC字节初始化
	unsigned char i=0;  //数组下标用
...
*********************************************************************/
unsigned char checkCRC(unsigned char CRCArray[],unsigned char ArrayLen)
{
	unsigned char CRCOK;
